...
trait Qualifier {
  ...
  class ClassProtectedThis(protected/**/[this]/**/ val x: Int)

  class TraitPrivate(private[parameter] val x: Int)

  class TraitProtected(protected[parameter] val x: Int)

  class TraitProtectedThis(protected/**/[this]/**/ val x: Int)
  ...
  enum EnumProtectedThis(protected/**/[this]/**/ val x: Int) {
    case Case/**/ extends EnumProtectedThis(1)/**/
  }
  ...
  enum EnumCaseClassProtectedThis {
    case Class(protected/**/[this]/**/ val x: Int)
  }
